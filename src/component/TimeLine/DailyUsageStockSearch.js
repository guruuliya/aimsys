  ...
  render() {
    ...
    var frombuttondate=this.state.pickerValue3;
      ...
      var jsonyear = json.filter(function (item) {
        ...
        if (((new Date(item.DPickdobStock).getFullYear() == frombuttonyear))&&((new Date(item.DPickdobStock).getMonth() == frombuttonmonth))&&((new Date(item.DPickdobStock).getDate() == frombuttondate))) return item;
      })

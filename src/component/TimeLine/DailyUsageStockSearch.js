...
import { dailyUsageStockFetch } from '../../actions/DailyUsageStockAction';
import DailyUsageStockListItem from './DailyUsageStockListItem';
...
class DailyUsageStockSearch extends Component {
  state = {};
  constructor(props) {
    super(props);
    this.state = {
  ...
  renderRow(child) {
    return <DailyUsageStockListItem child={child} />;
  }
  ...
  render() {
    ...
    if ((this.state.pickerValue1) && !(this.state.pickerValue2) && !(this.state.pickerValue3)) {
      this.state.pickerValue2 = null;
      this.state.pickerValue3 = null;
      name = this.state.pickerValue1;
 
    } else if ((this.state.pickerValue3) && !(this.state.pickerValue1) && !(this.state.pickerValue2)) {
      this.state.pickerValue2 = null;
      this.state.pickerValue1 = null;
      name = this.state.pickerValue3;
    }
    else if ((this.state.pickerValue2) && !(this.state.pickerValue1) && !(this.state.pickerValue3)) {
      this.state.pickerValue1 = null;
      this.state.pickerValue3 = null;
      name = this.state.pickerValue2;
    } else if (this.state.pickerValue1 && this.state.pickerValue2 && !(this.state.pickerValue3)) {
      this.state.pickerValue3 = null;
      name = this.state.pickerValue1 + '-' + this.state.pickerValue2;
    } else if (this.state.pickerValue2 && this.state.pickerValue3 && !(this.state.pickerValue1)) {
      this.state.pickerValue1 = null;
      name = this.state.pickerValue2 + '-' + this.state.pickerValue3;
    } else if (this.state.pickerValue1 && this.state.pickerValue3 && !(this.state.pickerValue2)) {
      this.state.pickerValue2 = null;
      name = this.state.pickerValue1 + '-' + ' ' + '-' + this.state.pickerValue2;
    }
    else if (this.state.pickerValue1 && this.state.pickerValue2 && this.state.pickerValue3) {
      name = this.state.pickerValue1 + '-' + this.state.pickerValue2 + '-' + this.state.pickerValue3;
    }
...
const mapStateToProps = state => {
  const DailyUsageStockFetchKey = _.map(state.DailyUsageStockFetchKey, (val, uid) => {
    return { ...val, uid };
  });
  return { DailyUsageStockFetchKey };
};

export default connect(mapStateToProps, { dailyUsageStockFetch })(DailyUsageStockSearch);
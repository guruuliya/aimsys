  ...
  render() {
    ...
    this.props.three_year_to_six_year != ''
      ? this.props.dailyUsageUpdate({
          name: 'total1',
          value:
            parseInt(this.props.six_months_to_one_year) +
            parseInt(this.props.one_year_to_three_year) +
            parseInt(this.props.three_year_to_six_year)
        })
      : null;
    ...
    this.props.pw_4thgrade != ''
      ? this.props.dailyUsageUpdate({
          name: 'total2',
          value:
            parseInt(this.props.pw_prenatal) +
            parseInt(this.props.pw_postnatal) +
            parseInt(this.props.pw_3rdgrade) +
            parseInt(this.props.pw_4thgrade)
        })
      : null;
    ...
    this.props.total1 != '' && this.props.total2 != ''
      ? this.props.dailyUsageUpdate({
          name: 'totalfinal',
          value: parseInt(this.props.total1) + parseInt(this.props.total2)
        })
      : null;
